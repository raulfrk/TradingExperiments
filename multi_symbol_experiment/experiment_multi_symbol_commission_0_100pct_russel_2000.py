"""
Experiment: 0 % commission, testing Russell 2000
"""
import tempfile
import time
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment("multi_symbol_russel2000_max_size_100_0_commission")
    runs = 1
    ...
    for symbol in symbols:
        ...
        for i in range(runs):
            ...
            with mlflow.start_run():
                ...
                run_experiment(train, test, symbol, [], 0, 100_000, CANDLE_DATA_OBSERVABLE_COLUMNS)
