"""
Experiment: 0.03 % commission, testing SNP500.
"""
import tempfile
import time
...
def run_experiment(train, test, symbol, required_headline_content, commission, initial_cash, obs_columns, max_size=None):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        all_stats, all_trades = multi_day_backtesting(test, initial_cash, obs_columns, "LongOnlyStockTradingEnv-v0", temp_dir/"best_model.zip", verbose=True, max_size=max_size)
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment("multi_symbol_snp500_max_size_100pct")
    runs = 1
    ...
    for symbol in symbols:
        ...
        for i in range(runs):
            ...
            with mlflow.start_run():
                ...
                run_experiment(train, test, symbol, ["microsoft"], 0.0003, 100_000, CANDLE_DATA_OBSERVABLE_COLUMNS)
