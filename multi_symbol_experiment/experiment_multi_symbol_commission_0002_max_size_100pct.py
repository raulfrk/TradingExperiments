"""
Experiment: 0.02 % commission, testing SNP500.
"""
import tempfile
import time
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment("multi_symbol_snp500_max_size_100pct_0002_commission")
    runs = 1
    ...
    for symbol in symbols:
        ...
        for i in range(runs):
            ...
            with mlflow.start_run():
                ...
                run_experiment(train, test, symbol, [], 0.0002, 100_000, CANDLE_DATA_OBSERVABLE_COLUMNS)
