"""
Experiment: 0.01 % commission, testing Russell2000.
"""
import tempfile
import time
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment("multi_symbol_russel2000_max_size_100pct_0001_commission")
    runs = 1
    symbols = ["SMCI", "SSD", "CYTK", "ELF", "MSTR", "UFPI", "LNW", "ONTO", "RMBS", "BRBR"]
    ...
    for symbol in symbols:
        ...
        for i in range(runs):
            ...
            with mlflow.start_run():
                ...
                run_experiment(train, test, symbol, [], 0.0001, 100_000, CANDLE_DATA_OBSERVABLE_COLUMNS)
